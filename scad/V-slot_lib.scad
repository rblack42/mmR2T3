...
//V_slot("20x20",10);//rotate([0,90,0]) V_slot("20x40",1500);
//V_slot("20x60",30);
//V_slot("20x80",40);
//V_slot("40x40",20);
//V_slot("C-beam",10);
...
module slot(a,b,c) {
    if(c=="y") {
        hull() {
            translate([0,0,-4.5]) cube([a,b,9]);
            translate([1.7,-1.7,-2.8]) cube([a-2*1.7,b+1.7,5.6]);
        }
        ...
        hull() {
            translate([0,0,-4.5]) cube([a,b,9]);
            translate([0,-1.7,-2.8]) cube([a,b+1.7,5.6]);
        }
    }
}
